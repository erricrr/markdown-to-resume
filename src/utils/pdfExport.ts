    ...
    <head>
      ...
      <style>
        ...
        * {
        ...
        /* Font face declarations for PDF embedding */
...
/* MINIMALIST TEMPLATE - Maximum whitespace */
.template-minimalist {
background: white;
...
.template-creative {
  ...
  padding: 0.75rem 2.5rem 2.5rem 4.5rem;
  position: relative;
  ...
  * {
    ...
    color-adjust: exact !important;
          ...
          *::before, *::after {
          ...
          /* Specific Creative template print fixes */
          .template-creative {
            padding: 0.75rem 2.5rem 2.5rem 4.5rem !important;
          }
